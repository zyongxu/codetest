 ...
 *  Federaton: each cluster is connected to other clusters as a worker,
 *             the broker in a cluster cannot tell which is a local worker
 *             and which is another cluster
 *
 *  Note:
 *      It is legal to both bind a socket to an endpoint
 *      and connect it to other endpoints!
 */
#include "czmq.h"
