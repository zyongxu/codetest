 ...
 *   2. Accepts connections from a set of workers.
 *   3. Accepts requests from clients and holds these in a single queue.
 *   4. Sends these requests to workers using the load balancing pattern.
 *   5. Receives replies back from workers.
 *   6. Sends these replies back to the original requesting client.
 */
...
client_thread (void *arg) {
    ...
    s_set_id (client);  // Set simple random printable identity on socket
