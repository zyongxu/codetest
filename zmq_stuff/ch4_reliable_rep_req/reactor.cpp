// zloop() is a function in CZMQ High-level API.
// It's a simple but functional reactor. Lets you:
//   1. Set a reader on any socket, i.e., code that is called whenever the socket has input.
//   2. Cancel a reader on a socket.
//   3. Set a timer that goes off once or multiple times at specific intervals.
//   4. Cancel a timer.
// zloop uses zmq_poll internally, it REBUILDS its poll set each time you ADD or REMOVE readers
